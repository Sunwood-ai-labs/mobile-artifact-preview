...
color="${MOBILE_ARTIFACT_THEME_COLOR:-#07111d}"
primary_color="${MOBILE_ARTIFACT_THEME_PRIMARY_COLOR:-#41d3ff}"
background_color="${MOBILE_ARTIFACT_THEME_BACKGROUND_COLOR:-#02070d}"
viewer_accent="${MOBILE_ARTIFACT_VIEWER_ACCENT:-#41d3ff}"
viewer_highlight="${MOBILE_ARTIFACT_VIEWER_HIGHLIGHT:-#ffbe6a}"
